           ...
           <div className="flex flex-col flex-1 p-5 gap-3">
               {/* Course title */}
                ...
                <div className="flex flex-wrap gap-2">
                       {data.duration && (
                           <span 
                             className="text-[11px] bg-orange-50 text-pink-600 font-semibold px-3 py-1 rounded-full"
                           >
                              ⏱ {data.duration}
                           </span>
                       )}
                       {data.mode && (
                           <span 
                             className="text-[11px] bg-blue-50 text-pink-500 font-semibold px-3 py-1 rounded-full"
                           >
                             🖥 {data.mode}
                            </span>
                        )}
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100">
                        <button
                            ...
                            className="bg-pink-500 hover:bg-pink-700 active:scale-95 text-white text-xs font-bold px-5 py-2.5 rounded-xl transition-all duration-200 shadow-md hover:shadow-orange-200"
                        >
                         View More →
                        </button>
                    </div>
