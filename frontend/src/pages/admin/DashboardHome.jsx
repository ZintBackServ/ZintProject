...
function DashboardHome() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-10">
      ...
      {/* ── HEADER ── */}
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 md:px-8 py-4 sm:py-6 mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition shadow-sm w-full sm:w-auto sm:self-auto"
          >
      ...
      <div className="px-4 sm:px-6 md:px-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          {stats.map((stat) => (
            <div
              key={stat.title}
              className={`rounded-2xl border p-3 sm:p-5 ${stat.color} transition hover:shadow-md`}
            >
              <div className="flex items-center justify-between mb-2 sm:mb-3">
                <span className="text-2xl sm:text-3xl">{stat.icon}</span>
                <span className="text-xl sm:text-3xl font-bold">{stat.value}</span>
              </div>
              <p className="text-xs sm:text-sm font-semibold mb-2 sm:mb-3">{stat.title}</p>
              <div className="w-full bg-white bg-opacity-60 rounded-full h-1.5 mb-2 sm:mb-3">
                <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-100">
              <h2 className="font-bold text-gray-900 text-sm sm:text-base">Recent Courses</h2>
              <Link
                to="/admin/dashboard/AddCourse"
              ...
              <div className="divide-y divide-gray-50">
                {courses.slice(0, 6).map((course) => {
                  ...
                  return (
                    <div
                      key={course._id}
                      className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-3 sm:py-4 hover:bg-gray-50 transition"
                    >
                      {/* Course image */}
                      <div className="w-10 h-9 sm:w-12 sm:h-10 rounded-lg overflow-hidden flex-shrink-0 bg-gray-100">
                        {course.courseImage && (
                          <img
                      ...
                      {/* Mode badge */}
                      <span className={`text-[10px] sm:text-xs font-semibold px-2 sm:px-2.5 py-1 rounded-full flex-shrink-0 whitespace-nowrap
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-5">
              <h2 className="font-bold text-gray-900 text-sm sm:text-base mb-3 sm:mb-4">Quick Actions</h2>
              <div className="grid grid-cols-2 sm:grid-cols-1 gap-2">
                {quickActions.map((action) => (
                  <Link
                    key={action.path}
                    to={action.path}
                    className={`${action.color} text-white text-xs sm:text-sm font-medium px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl transition flex items-center justify-center sm:justify-start gap-2 text-center`}
                  >
            ...
            {/* Summary card */}
            <div className="bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl p-4 sm:p-5 text-white shadow-sm">
              <h2 className="font-bold text-sm sm:text-base mb-1">Institute Summary</h2>
              <p className="text-indigo-200 text-xs mb-3 sm:mb-4">Zint Institute Overview</p>
        ...
        {categories.length > 0 && (
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-100">
              <h2 className="font-bold text-gray-900 text-sm sm:text-base">Categories</h2>
              <Link
                to="/admin/dashboard/AddCategory"
                className="text-xs text-purple-600 hover:text-purple-800 font-semibold flex-shrink-0"
              >
                + Add Category
              </Link>
            </div>
