...
export default function CourseSlider() {
  ...
  return (
    /* Keep this light course gallery visually separate from the dark home page. */
    <section className="w-full bg-white py-10 sm:py-12">
      ...
      <div
        ref={trackRef}
        className="flex gap-4 sm:gap-5 overflow-x-auto snap-x snap-mandatory pb-2 scroll-smooth"
